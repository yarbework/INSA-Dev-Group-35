...
export function LoginButton({ loggedIn, onLogout }: LoginButtonProps) {
  ...
  return (
    <button
      ...
      className="w-full md:w-auto px-5 py-2 rounded-lg font-semibold transition-colors duration-300 border-2 border-blue-600 text-gray-600 hover:bg-blue-600 hover:text-white"
    >
